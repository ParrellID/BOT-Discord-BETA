  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("840260133686870036").setLabel("Tutorial").setURL("https://www.youtube.com/c/FarrellID")
        let menuOptions = [
          {
            label: "Overview",
            value: "Overview",
...
<:MilratoDevelopment:900389724936609842>  Made by [**FarrellID**](https://parrellid.vercel.app)`)
